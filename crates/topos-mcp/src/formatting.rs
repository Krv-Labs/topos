...
use topos_core::evaluation::policies::gates::PILLAR_METRIC_PREFIXES;
use topos_core::evaluation::preferences::UserPreferences;
use topos_core::evaluation::suggestions::suggest_refactors;
use topos_core::evaluation::suppression::AdjustedVerdict;
...
fn generator_wire(g: topos_core::evaluation::preferences::Generator) -> GeneratorInput {
    use topos_core::evaluation::preferences::Generator;
    match g {
...
pub fn to_evaluation_result(
    ...
    let core_findings: Vec<topos_core::evaluation::security_guidance::SecurityFinding> =

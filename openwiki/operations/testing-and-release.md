...
Sphinx docs build through `.github/workflows/docs.yml`. Two currently similar scheduled OpenWiki workflows invoke `openwiki code --update --print` and create a documentation PR; review duplicate scheduling before changing automation. Generated pages belong under `openwiki/`; do not alter `openwiki/INSTRUCTIONS.md` as part of routine generation.

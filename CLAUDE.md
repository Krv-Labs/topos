...
The OpenWiki GitHub Actions workflow (`.github/workflows/openwiki.yml`) refreshes the repository wiki on merge/push to `main` (and manual dispatch) — not on a cron schedule. Do not hand-edit generated OpenWiki pages unless explicitly asked; prefer updating source code/docs and letting OpenWiki regenerate.
